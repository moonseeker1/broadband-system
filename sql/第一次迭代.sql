CREATE TABLE `address_book`  (
  ...
  `city` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_german2_ci NOT NULL COMMENT '市级',
...
CREATE TABLE `broadband_service`  (
  `broadband_service` int NOT NULL,
  `type_id` int NULL,
...
CREATE TABLE `workorder`  (
  ...
  `workorder_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `service_id` int NULL,
...
ALTER TABLE `service_type` ADD CONSTRAINT `fk_service_type_broadband_service_1` FOREIGN KEY (`type_id`) REFERENCES `broadband_service` (`type_id`);
ALTER TABLE `sys_role` ADD CONSTRAINT `fk_sys_role_sys_role_menu_1` FOREIGN KEY (`role_id`) REFERENCES `sys_role_menu` (`role_id`);
ALTER TABLE `sys_role_menu` ADD CONSTRAINT `fk_sys_role_menu_sys_menu_1` FOREIGN KEY (`menu_id`) REFERENCES `sys_menu` (`menu_id`);
ALTER TABLE `sys_user` ADD CONSTRAINT `fk_sys_user_sys_user_role_1` FOREIGN KEY (`user_id`) REFERENCES `sys_user_role` (`user_id`);
ALTER TABLE `sys_user` ADD CONSTRAINT `fk_sys_user_address_book_1` FOREIGN KEY (`user_id`) REFERENCES `address_book` (`user_id`);
ALTER TABLE `sys_user_role` ADD CONSTRAINT `fk_sys_user_role_sys_role_1` FOREIGN KEY (`role_id`) REFERENCES `sys_role` (`role_id`);
ALTER TABLE `workorder` ADD CONSTRAINT `fk_workorder_broadband_service_1` FOREIGN KEY (`service_id`) REFERENCES `broadband_service` (`broadband_service`);
ALTER TABLE `workorder` ADD CONSTRAINT `fk_workorder_sys_user_1` FOREIGN KEY (`user_id`) REFERENCES `sys_user` (`user_id`);
